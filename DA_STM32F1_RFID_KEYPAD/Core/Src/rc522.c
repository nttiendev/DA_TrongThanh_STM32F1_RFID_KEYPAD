...
uint8_t TM_SPI_Send(uint8_t data) //Hàm truyen nhan spi co ban
{
	...
	return data_re[0];
	//Hàm này không có gì phai giai thích, chi don gian là dùng cho SPI de gui 1byte di và nhan ve 1 byte
}
